describe('other', function() {
  ...
  it('check result by Concatenation Test for 4-D input with axis being 0', async function() {
  ...
  it('check result by Concatenation Test for 4-D input with axis being 2', async function() {
    let model = await nn.createModel(options);
  ...
  it('check result by Reshape Test using special value -1', async function() {
    let model = await nn.createModel(options);
